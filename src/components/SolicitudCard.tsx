...
export function SolicitudCard({ solicitud }: { solicitud: Solicitud }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-4 transition-shadow hover:shadow-md focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 dark:border-zinc-800 dark:bg-zinc-900"
    >
      ...
      <span className="mt-1 inline-flex items-center gap-1 text-xs font-medium text-zinc-400 transition-colors group-hover:text-red-600 dark:group-hover:text-red-400">
        Ver detalle
